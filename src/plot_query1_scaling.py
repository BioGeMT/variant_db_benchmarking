...
df = pd.read_csv('data/query1_subsamples.csv')
...
plt.tight_layout()
plt.savefig('plots/query1_scaling_cold.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('plots/query1_scaling_warm.png', dpi=300, bbox_inches='tight')
